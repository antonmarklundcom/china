...
$sections = [
    [
        ...
        'body' => [
            ...
            'La Feria de Cantón (China Import and Export Fair) se realiza en Guangzhou dos veces por año, en primavera y en otoño, y cada edición se divide en tres fases con categorías de productos distintas. Las fechas exactas de cada edición las publica la organización en cantonfair.org.cn; verifíquelas allí antes de comprar pasajes. En nuestra página sobre la [Feria de Cantón](/feria-de-canton/) resumimos cómo está organizada.',
        ],
    ],
    [
        'h2'   => 'Meses antes: elegir la fase',
        'body' => [
            'Cada fase reúne rubros diferentes. En las ediciones recientes, la primera fase se orienta a electrónica, electrodomésticos, maquinaria, ferretería, energía y vehículos; la segunda a artículos para el hogar, cocina, cerámica, muebles, regalos, decoración y materiales de construcción; y la tercera a textiles, ropa, calzado, juguetes, papelería, alimentos y productos de salud y recreación. La distribución exacta puede cambiar de una edición a otra.',
    ...
    [
        ...
        'body' => [
            'Los compradores extranjeros deben hacer el registro previo en línea en el sistema de compradores del sitio oficial de la feria y, con ese registro y su pasaporte, obtienen la credencial de ingreso (buyer badge). Hágalo con anticipación: el registro previo le ahorra filas el primer día.',
            'Desde el mismo sistema de registro, la feria emite cartas de invitación para compradores extranjeros, que sirven como respaldo para la solicitud de visa; la carta no reemplaza la credencial de ingreso. Guarde en el teléfono y en papel el comprobante de registro.',
        ],
    ],
    [
        'h2'   => 'Visa y pasaje',
        'body' => [
            'Paraguay no tiene relaciones diplomáticas con la República Popular China, de modo que no hay embajada ni consulado de la RPC en Asunción. Los ciudadanos paraguayos deben averiguar dónde y cómo tramitar la visa en una representación china de otro país de la región o mediante el procedimiento que esté vigente. Los requisitos y plazos cambian: confírmelos en el sitio oficial de la embajada o el consulado donde vaya a presentar la solicitud. Le explicamos las opciones en la guía de [visa china para paraguayos](/viajar-a-china/visa-china-para-paraguayos/).',
            'Inicie el trámite con margen, porque la solicitud se presenta en una representación fuera de Paraguay y el pasaporte queda retenido durante el trámite; si prefiere delegarlo, vea nuestro servicio de [trámite de visa china](/servicios/visa-china/). Los vuelos desde Asunción a Guangzhou tienen al menos una escala; compare rutas por São Paulo, Buenos Aires, Europa o Medio Oriente, y verifique si alguna escala exige visa de tránsito.',
        ],
    ],
    [
    ...
    [
        ...
        'items' => [
            ...
            ['title' => 'Muestras', 'text' => 'Pida muestras o catálogos solo de lo que realmente evalúa. Traer muestras en la valija puede tener límites y tributos; consulte antes con su despachante cómo se tratan en la aduana paraguaya.'],
    ...
    [
        ...
        'body' => [
            ...
            'Pida cotizaciones escritas con el mismo Incoterm para poder compararlas, solicite muestras de los finalistas y verifique la empresa antes del primer pago (vea cómo reconocer [proveedores chinos confiables](/importar/proveedores-chinos-confiables/)). Traer muestras en la valija puede tener límites y generar tributos: consulte antes con su despachante o revise el [régimen de equipaje y turismo](/aduana/regimen-de-turismo-paraguay/). Si piensa importar en volumen, coordine con un [despachante de aduana](/aduana/despachantes-de-aduana-paraguay/) la clasificación arancelaria y los requisitos de su producto antes de cerrar el pedido.',
        ],
    ],
];
...
$faq = [
    ...
    ['q' => '¿Dónde se tramita la visa china desde Paraguay?', 'a' => 'No hay embajada de la RPC en Asunción. Confirme en el sitio oficial de la representación china donde piense presentar la solicitud cuáles son los requisitos y el procedimiento vigentes; más detalle en visa china para paraguayos.'],
    ...
    ['q' => '¿Necesito hablar chino para ir a la feria?', 'a' => 'No es imprescindible. Muchos expositores hablan inglés y un traductor en el teléfono resuelve lo básico; para negociaciones complejas conviene un intérprete o un tour de negocios a China con acompañamiento.'],
];
