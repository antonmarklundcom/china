    ...
    '/aviso-legal/' => [
        ...
        'sections' => [
            [
                ...
                'body' => [
                    'China-Paraguay es un sitio privado de información. No es la Dirección Nacional de Aduanas, ni la Dirección Nacional de Ingresos Tributarios (DNIT), ni una embajada o consulado, ni representa a ningún organismo público de Paraguay, de China ni de otro país.',
                ],
            ],
            [
            ...
            [
                ...
                'body' => [
                    'Aduana: Dirección Nacional de Aduanas (aduana.gov.py). Impuestos: DNIT (dnit.gov.py). Visas para China: la misión diplomática china que corresponda a su residencia.',
                ],
            ],
        ],
        'stub' => false,
